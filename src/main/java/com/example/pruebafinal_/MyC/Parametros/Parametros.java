...
public class Parametros {
    ...
    public Parametros(Integer turnosDeVida, Integer numIndividuosInicial, Integer pRep, Integer pMuerte, Integer pClon, Double pBasico, Double pNormal, Double pAvanzado, Integer lado, Integer altura, Integer tiempoDeAparicion, Integer probabilidadDeAparicion,  Integer vidaAguaSuma, Integer pAgua, Integer vidaComidaSuma, Integer pComida, Integer vidaMontanaResta, Integer pMontana, Integer pReproTesoroSuma, Integer pTesoro, Integer pClonacionBiblioteca, Integer pBiblioteca, Integer muertePozo, Integer pPozo) {
